...
class Wapv {
	 ...
	 *
	 * - Wapv_Loader. Orchestrates the hooks of the plugin.
	 * - Wapv_i18n. Defines internationalization functionality.
	 * - Wapv_Admin. Defines all hooks for the admin area.
	 * - Wapv_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wapv-loader.php';
	 ...
	 *
	 * Uses the Wapv_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wapv_Admin( $this->get_plugin_name(), $this->get_version() );
